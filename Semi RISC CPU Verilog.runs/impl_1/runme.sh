...
HD_PWD='C:/Users/budhv/Documents/Personal Projects/Semi RISC CPU Verilog/Semi RISC CPU Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_basys3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_basys3_top.tcl -notrace
